...
;define("ember-formulaic/services/field-service", ["exports", "@glimmer/tracking", "@ember/service", "@ember/object", "@ember/array"], function (_exports, _tracking, _service, _object, _array) {
  ...
  _exports.default = void 0;
  var _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6; //services/field-service.js
  ...
  let FieldService = _exports.default = (_class = class FieldService extends _service.default {
    constructor(...args) {
      ...
      _initializerDefineProperty(this, "store", _descriptor, this);
      _initializerDefineProperty(this, "router", _descriptor2, this);
      _initializerDefineProperty(this, "currentFormFields", _descriptor3, this);
      _initializerDefineProperty(this, "currentForm", _descriptor4, this);
      _initializerDefineProperty(this, "currentField", _descriptor5, this);
      _initializerDefineProperty(this, "validators", _descriptor6, this);
    }
    fieldTypes() {
      return {
        TEXTFIELD: 'textfield',
    ...
    writable: true,
    initializer: null
  }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "currentFormFields", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "currentForm", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "validators", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
...
;
          if (!runningTests) {
            require("ember-formulaic/app")["default"].create({"API_HOST":"","API_NAMESPACE":"formulaic/api","LOG_RESOLVER":true,"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"ember-formulaic","version":"0.0.0+fd7ba8ae"});
          }
